#!/usr/bin/env python3
"""Validate evidence/runs/agent-loop.log contract (freshness + policy_source shape)."""
...
SOURCE_PATHS = [
    ROOT / "context_dev" / "planning" / "cli.py",
    ROOT / "context_dev" / "loops" / "scout.py",
    ROOT / "context_dev" / "loops" / "mcp_code_mode.py",
